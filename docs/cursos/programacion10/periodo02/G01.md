...
```{tab-item} Recursos (1)
- [TEXTO: Diagramas de flujo](../recursos/T02.md)
```
:::
...
1. Lea el siguiente caso:
    ...
    > "Suponga que un extranjero visita **Puerto Boyacá** y quiere hacer turismo en el pueblo.
...
2. En su **cuaderno**, cree un **diagrama de flujo** con 15 instrucciones que le permitan al extranjero llegar a cada una de las iglesias. Tenga en cuenta lo siguiente:
    ...
    - Para identificar las direcciones, se recomienda usar [Google Maps](https://www.google.com/maps/@5.9736064,-74.5865216,7242m).
