...
:TEMÁTICA: Variables en PYTHON
:OBJETIVO: Aplicar la teoría de variables en la consola interactiva de PYTHON 
:DESEMPEÑO: Aplica e identifica diferentes tipos de variables para ser usadas en la consola interactiva de PYTHON
