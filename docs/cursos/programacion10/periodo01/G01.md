...
```{tab-item} Recursos (1)
- [TEXTO: Fundamentos de arquitectura y lógica computacional](../recursos/T01.md)
```
:::
...
:::{pull-quote}
> "Aprender la diferencia entre software y programa, o entender cómo la CPU procesa datos, es la base para comprender cómo funciona la tecnología hoy. Esta guía esta diseñada para aprender a reconocer la jerarquía informativa que sostiene los sistemas modernos."
...
2. Dibuje una tabla en su cuaderno y en la primera columna escriba 15 ejemplos de datos. En la segunda columna convierta estos datos en información. En la tercera columna indique si la información es un valor cualitativo o cuantitativo.
    ...
    -|-|-
    Rojo|"El semáforo está en ROJO"|cualitativo
    16|"La edad del estudiante es 16 años"|cuantitativo
    :::
