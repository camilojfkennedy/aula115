# T01: Historia de la computación personal
...
El Internet tiene sus orígenes en **ARPANET**, un proyecto militar desarrollado en 1969 por el *Departamento de defensa de Estados Unidos*. Esta red inicial conectaba un número reducido de computadoras en distintas universidades.
...
* - ```{figure} ./recursos/t01/image02.png
    :align: center
    :width: 800
    **Primera página web:** Explicación de la Word Wide Web
    ```
:::
...
* - ```{figure} ./recursos/t01/image03.png
    :align: center
    :width: 700
    **MOSAIC:** Primer navegador web del mundo
    ```
:::
